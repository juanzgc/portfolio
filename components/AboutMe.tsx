  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-red-500">
        <RightTimeLine isStart={true} year="2016" title="Started my journey" description="Attended Boston University and pursued a Bachelor's of Science degree in Computer Engineering. (2016-2020)" />
        <LeftTimeLine year="2017" title="Covered Security - Internship" description="Full Stack Developer Intern. MEAN Stack (MongoDB, ExpressJS, AngularJS, NodeJS). Internship consisted of creating a Google Chrome browser extension that detects stored credit card information as you browse the web. (Mar 2017 - Sep 2017)" />
        <RightTimeLine year="2018" title="Livelo - Lead Software Developer" description="Full Stack Developer - Part Time. Create an E-Commerce Application for professional road bike rentals across 9 countries. Technologies used includes: NextJS, PostgreSQL, Auth0, Bootstrap, MaterialUI, & Prisma. (2018 - Present)" />
        <LeftTimeLine year="2019" title="Verto - Mobile Developer Intern" description="Developed a mobile application with React Native. Technologies include: Amazon Web Services, PassportJS, Chat Bot using AWS ElastiCache for Redis. (Feb 2019 - May 2019)" />
        <RightTimeLine year="2019" title="IBM - Internship" description="Full Stack Developer Intern. Architecture design and implementation lead for building out the Jira Access request capability within IBM Watson Health. Containerized NodeJS application utilizing Docker and a Kubernetes Cluster. Leveraged Atlassian Jira SDK to build a Jira REST Plugin. (May 2019 - Aug 2019)" />
        <LeftTimeLine isEnd={true} year="2020" title="IBM - Software Engineer Full Time" description="Design, develop, test and deliver offerings using leading edge and/or proven technologies. Work in an Agile, collaborative environment to understand stakeholder requirements. Design, code, and test innovative component-level software solutions. Ensure that the implemented solutions are unit tested and ready to be integrated into a product. Also debug customer-reported problems." />
      </div>
    </div>
  )
}
