  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap -m-4 mt-8">
        ...
        <ProjectCard href="https://hulu.juanzg.com" img="/hulu.png" alt="Hulu Clone" h1="Hulu Clone" p="NextJS, TailwindCSS, IMDB API" h2="UX Hulu Clone created with TailwindCSS and NextJS framwork. Movies are rendered via the IBMD API. Includes pagination, filtering, image optmization, caching, and more!" buttonText="Learn More" />
      </div>
    </div>
  )
}
